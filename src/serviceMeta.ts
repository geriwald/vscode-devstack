...
export const TECH_DESCRIPTIONS: Record<string, TechDescription> = {
  ...
  "Go":               { description: "Compiled backend language",            icon: "symbol-method",  color: "#00ADD8" },
  "FastAPI":          { description: "Python async web framework",           icon: "flame",          color: "#009688" },
  "Django":           { description: "Python full-stack web framework",      icon: "database",       color: "#44B78B" },
  "Flask":            { description: "Python lightweight web framework",     icon: "beaker",         color: "#CCCCCC" },
  "Python Script":    { description: "Standalone Python server script",      icon: "snake",          color: "#3776AB" },
